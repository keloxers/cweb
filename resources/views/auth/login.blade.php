	...
	<div class="container">
		<div class="full-content-center">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('login') }}">
            ...
            <input id="email" type="email" class="form-control text-input" name="email" value="{{ old('email') }}" required autofocus>
            @if ($errors->has('email'))
            ...
            <input id="password" type="password" class="form-control text-input" name="password" required>
